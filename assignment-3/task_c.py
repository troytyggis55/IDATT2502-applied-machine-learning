...
for epoch in range(20):
    for batch in range(len(x_train_batches)):
        ...
        print("epoch = %s, batch = %s, loss = %s" % (epoch, batch, model.loss(x_train_batches[batch], y_train_batches[batch])))

    accuaracies.append(model.accuracy(x_test, y_test))
    print("accuracy = %s" % accuaracies[-1])
